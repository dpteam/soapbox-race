...
public class BadgeDefinitionEntity implements ISoapBoxEntity {
	...
	public BadgeDefinitionPacketType toPacket() {
		BadgeDefinitionPacketType packet = new BadgeDefinitionPacketType();
